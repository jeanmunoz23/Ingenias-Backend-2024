...
app.get(rutaBase, (req, res) => { res.status(200).end('¡Bienvenido a la API de frutas!'); } );

//Endpoints
app.get(rutaBase+'/frutas', async (req, res) => {
...
// Metodos de lectura
app.get(rutaBase+'/frutas/:id', async (req, res) => {
...
app.get(rutaBase+'/frutas/nombre/:nombre', async (req, res) => {
...
app.get(rutaBase+'/frutas/precio/:precio', async (req, res) => {
...
// Metodo de creacion
app.post(rutaBase+'/frutas', async (req, res) => { 
...
app.put(rutaBase+'/frutas/:id', async (req, res) => { 
...
app.delete(rutaBase+'/frutas/:id', async (req, res) => { 
